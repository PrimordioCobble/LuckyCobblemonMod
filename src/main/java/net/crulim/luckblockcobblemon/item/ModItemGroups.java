...
public class ModItemGroups {
    ...
    public static final ItemGroup LUCK_BLOCKS_GROUP = Registry.register(Registries.ITEM_GROUP, Identifier.of(LuckBlockCobblemon.MOD_ID, "luckblocks"),
            FabricItemGroup.builder()
                    .icon(() -> new ItemStack(ModBlocks.LUCK_BLOCK_POCKET))
                    .displayName(Text.translatable("itemgroup.luckblockcobblemon.luckblocks"))
                    .entries((displayContext, entries) -> {
                        ...
                        for (Block block : ModBlocks.getAllLockedBlocks()) {
                            entries.add(block);
                        }
                    })
                    .build());
