...
import net.crulim.luckblockcobblemon.block.custom.CustomTrapdoorBlock;
...
public class ModBlocks {
   ...
   // public static final Block LUCKY_BLOCK_COBBLE = registerBlock("lucky_block_cobble", new CobbleLuckyBlock());
    ...
    public static final Block LUCK_BLOCK_VANILLA = registerBlock("luck_block_vanilla",
            new BaseDirectionalBlock(AbstractBlock.Settings.create().strength(0.5f).sounds(BlockSoundGroup.AMETHYST_BLOCK)));
